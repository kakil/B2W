...
$num_of_reviews				= get_field('num_of_reviews');
$num_of_courses				= get_field('num_of_courses');
			...
			<div class="col-sm-8 col-md-6">
				...
				<div class="row">
					...
					<div class="col-xs-4">
						<div class="num">
							<div class="num-content">
								<?php echo $num_of_reviews; ?> <span>reviews</span>
							</div><!-- num-content -->
						</div><!-- num -->
					</div><!-- end col -->
					...
					<div class="col-xs-4">
						<div class="num">
							<div class="num-content">
								<?php echo $num_of_courses; ?> <span>courses</span>
							</div><!-- num-content -->
						</div><!-- num -->
					</div><!-- end col -->
